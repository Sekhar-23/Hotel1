    ...
    <div class="addroomsection">
        <form action="" method="POST">
            ...
            <select name="staffwork" class="form-control">
                ...
                <option value="weighter">General Manager</option>
                <option value="weighter">Receptionist</option>
            </select>

            <button type="submit" class="btn btn-success" name="addstaff">Hire Staff</button>
        </form>
